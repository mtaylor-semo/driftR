...
#      sliderInput("Waa","Fitness of genotype AA",value=1,min=0,max=1),
      withMathJax(),
      sliderInput("Waa","Fitness of genotype \\(A_1A_1\\)",value=1,min=0,max=1),
      sliderInput("Wab","Fitness of genotype \\(A_1A_2\\)",value=0.95,min=0,max=1),
      sliderInput("Wbb","Fitness of genotype \\(A_2A_2\\)",value=0.90,min=0,max=1),
